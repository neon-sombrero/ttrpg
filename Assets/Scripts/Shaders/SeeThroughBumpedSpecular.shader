Shader "SeeThrough/Bumped Specular"
{
	Properties
	{
		...
		_Shininess ("Shininess", Range (0.1, 1)) = 0.078125
		_SpecTex ("Specularity", 2D) = "white" {}
		[Normal]
	...
	SubShader
	{
		...
		void surf (Input IN, inout SurfaceOutput o)
		{
			...
			half4 s = tex2D (_SpecTex, IN.uv_SpecTex);
			o.Specular = _Shininess;
			o.Gloss = s.r/_Shininess;
			o.Normal = UnpackNormal(tex2D(_BumpMap, IN.uv_SpecTex));
